  ...
  <div class="login-container">
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
      ...
      <div class="title-container">
        <span><h2 class="title-text">农业可视化系统</h2></span>
      </div>
...
import logoImg from '@/assets/logo/yy.jpg'
...
.login-container {
  ...
  width:100%;
  height:100%;
  background-image: url('../../assets/logo/index_bg.png');
  background-size: 100% ;
  ...
  .title-container {
        ...
        padding-bottom: 50px;
				...
				// flex-direction: row;/*容器内项目的排列方向(默认横向排列 row)*/
